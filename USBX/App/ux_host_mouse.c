...
VOID hid_mouse_thread_entry(ULONG thread_input)
{
  ...
  while (1)
  {
    ...
    {
      /* Get Mouse position */
      if ((ux_host_class_hid_mouse_position_get(mouse, &actual_Pos_x, &actual_Pos_y) == UX_SUCCESS) && (mouse != NULL))
      {
      ...
      if ((ux_host_class_hid_mouse_buttons_get(mouse, &actual_mouse_buttons) == UX_SUCCESS) && (mouse != NULL))
      {
      ...
      if ((ux_host_class_hid_mouse_wheel_get(mouse, &actual_mouse_wheel) == UX_SUCCESS) && (mouse != NULL))
      {
